...
1. Ensure you have configured the `central` server credentials in your `~/.m2/settings.xml`:
...
This uses the `central-publishing-maven-plugin` to publish directly to Maven Central.
